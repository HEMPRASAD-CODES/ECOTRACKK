...
CSV_FILE = "Web project ECOTRACK_OG/blood_banks.csv"
...
with open('Web project ECOTRACK_OG/creds.json') as f:
...
def load_model():
    ...
    model = joblib.load('Web project ECOTRACK_OG/stress_model.pkl')
    scaler = joblib.load('Web project ECOTRACK_OG/scaler.pkl')
    return model, scaler
...
def main(start_city, end_city, stop_loc, vehicle_input,cargo_weight, num_gears, transmission_type, engine_size,fuel_type_start, cylinders, fuel_consumption_comb, air_travel_start):
    ...
    airport_data = pd.read_csv("Web project ECOTRACK_OG/airports.csv")
